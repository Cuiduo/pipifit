...
<template>
    <div>
              ...
              <swiper :options="swiperOption2" class ref="thrSwiper">
                <swiper-slide v-for="(item,index) in get_threetwodata" :key="index">
...
export default {
    ...
    computed: {        
        ...
        fun(){
            return  this.get_threetwodata;
            // return this.list4Data = this.get_threetwodata;
        },
        
    },
    created(){
        console.log(this.get_threetwodata);
        this.list4Data = this.get_threetwodata;
    },
    methods:{
         gothreeDetail(index){
